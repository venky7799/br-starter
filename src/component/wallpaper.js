...
import {ReactComponent as Hover} from '../assets/hovereffect.svg';
        ...
        <div className="pagee">
            <section id="pagee_unclear">
                    ...
                    {/* <img alt="bricksroot zindex" src={will}/> */}
                        <img alt="solarmessage" src={solarmessage}/>
                        <img alt="solarsee" src={solarsee}/>
                    ...
                    <div className="row v-center o-center">
                        <div className="project">
                            ...
                            <div className="projectimages">
                                <div className="image">
                                <div className="hovereffect"> <Hover /></div>
